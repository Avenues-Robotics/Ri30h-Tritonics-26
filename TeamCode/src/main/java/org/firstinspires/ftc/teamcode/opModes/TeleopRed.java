...
public class TeleopRed extends PeregrineTeleop {
    ...
    public static double speedPollen = 1000;
    public static double speedNectar = 1000;
    public static double speedStore  = 0.4;
    public static double speedLaunch = 1;

    @Override
    public Task defineTasks() {
        Task intake = new SmartIntake(this, intakePower);
        ...
        Task nearFlower = new TeleopTask(this, new Drive(this, "near-flower-shoot"), () -> gamepad1.a, true);
        Task rightFlower = new TeleopTask(this, new Drive(this, "right-flower-shoot"), () -> gamepad1.b, true);
        Task farFlower = new TeleopTask(this, new Drive(this, "far-flower-shoot"), () -> gamepad1.y, true);
        Task leftFlower = new TeleopTask(this, new Drive(this, "left-flower-shoot"), () -> gamepad1.x, true);
        ...
        return new ParallelTask(intake, powerLauncher, transferTeleop, leftHive, rightHive, nearFlower,
                rightFlower, farFlower, leftFlower, drive);
    }
